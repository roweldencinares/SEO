...
export function generateOrganizationSchema(data) {
  const {
    ...
    logo = 'https://www.spearity.com/wp-content/uploads/2024/logo.png',
    description = 'Leadership and business coaching services in Milwaukee',
    telephone = '+1-414-265-5755',
    email = 'info@spearity.com',
    address = {
    ...
    sameAs = [
      'https://www.linkedin.com/company/spearity',
      'https://www.facebook.com/spearity',
      'https://twitter.com/spearity'
    ]
  } = data;
...
export function generateLocalBusinessSchema(data) {
  const {
    name = 'Spearity',
    image = 'https://www.spearity.com/wp-content/uploads/2024/business-photo.jpg',
    priceRange = '$$',
...
export function generateBlogPostingSchema(data) {
  const {
    ...
    publisher = {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://www.spearity.com/wp-content/uploads/2024/logo.png"
      }
    },
    url,
    wordCount,
...
export function generateReviewSchema(data) {
  ...
  return {
    ...
    "itemReviewed": {
      "@type": "Organization",
      "name": itemReviewed.name || "Spearity",
      "url": itemReviewed.url || "https://www.spearity.com"
    },
    "reviewRating": {
      "@type": "Rating",
